...
var missile, missileImg, missiles = 5, missileGrp;
var score = 0;
...
function draw() {
  ...
  if(gameState === "lost"){
      textSize(50);
      fill("white");
      text("The Player Has Lost",displayWidth/2,displayHeight/2);
      asteroidGrp.destroyEach();
      spaceShip.destroy();
  }
  ...
  if(gameState === "won"){
    textSize(50);
    fill("white");
    text("The Player Has Won",displayWidth/2,displayHeight/2);
    asteroidGrp.destroyEach();
    spaceShip.destroy();
  }
}
